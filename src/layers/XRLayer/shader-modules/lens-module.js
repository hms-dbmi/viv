export default {
  ...
  fs: `\
  bool fragInLensBounds(vec2 lensCenter, vec2 vTexCoord, float majorLensAxis, float minorLensAxis, float lensBorderRadius) {
...
bool fragOnLensBounds(vec2 lensCenter, vec2 vTexCoord, float majorLensAxis, float minorLensAxis, float lensBorderRadius) {
