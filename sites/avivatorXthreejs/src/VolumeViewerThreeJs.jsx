...
import { VolumeView, getDefaultInitialViewState } from '@hms-dbmi/viv';
import { ColorPalette3DExtensions } from '@hms-dbmi/viv';

import ThreeJsViewer from './ThreeJsVolumeViewer';
...
const ThreeJsVolumeViewer = props => {
  const {
    loader,
    contrastLimits,
    colors,
...
export default ThreeJsVolumeViewer;
